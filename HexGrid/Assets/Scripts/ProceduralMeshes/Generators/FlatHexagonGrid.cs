...
namespace ProceduralMeshes.Generators
{
    ...
    {
        public const int VertexPerHexagon = 7;
        public const int TrianglePerHexagon = 6;


        public int Resolution { get; set; }

        public int VertexCount => VertexPerHexagon * Resolution * Resolution;

        public int IndexCount => TrianglePerHexagon * 3 * Resolution * Resolution;
        ...
        {
            int vi = VertexPerHexagon * Resolution * x;
            int ti = TrianglePerHexagon * Resolution * x;
            ...
            for (int z = 0; z < Resolution; ++z, vi += VertexPerHexagon, ti += TrianglePerHexagon)
            {
